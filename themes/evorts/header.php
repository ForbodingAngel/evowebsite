		...
		<div class="hero">
			<div class="row">
				<div class="column gray">
					<span class="herotext">
						The Battle Begins Now!</br>
						Construct your Base</br>
						Slaughter your enemies</br>
						Claim your title</br>
					</span>
					</br>
					<div class="ctabutton">Play Now for Free</div>
					</br>
				</div>
				<div class="column gray">
					<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/lgTW6J0VSlk?si=0iZkl2D6QdpucoU5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
